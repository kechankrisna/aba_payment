...
class PhoneCodeService {
  ...
  static bool isValidateDialCode(String dialCode) {
    return values.indexWhere((e) => e.dialCode.contains(dialCode) ) >= 0;
  }
}
...
class CountryCode {
  ...
  @override
  String toString() =>
      'CountryCode(name: $name, dialCode: $dialCode, code: $code)';
